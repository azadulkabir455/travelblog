    ...
    return (
      <>
        <div className="container-fuild">
          <div className="signInSignUpContainer position-absolute h-100 overflow-hidden">
            <div className="row align-items-stretch h-100">
              <div className="col-12 col-lg-7 signInSignUpContainerLeftSide d-flex flex-column align-items-center justify-content-center">
                <div className="contentContainer w-75 mb-5 p-5 bg-black bg-opacity-25 shadow-lg  rounded-3">
