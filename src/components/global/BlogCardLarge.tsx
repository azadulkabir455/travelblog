        ...
        <div className="card border-0 shadow-lg rounded-3 mb-5 blogCardLarge">
          {
            ...
            <img
              ...
              alt=""
              className={`img-fluid d-block w-100 rounded-top-3 object-fit-cover ${large?"large":""}`}
            />
            <div 
          ...
          <ReactPlayer className={`media  ${large?"large":""} rounded-top-3 overflow-hidden`} width="100%" height="400px" controls={true} url="https://youtu.be/HurjfO_TDlQ?si=OsW0Lknldl0B-3hN" />
          }

          
          <div className="card-body p-4">
            <h4 className="mb-2 ps-4 text-primary text-uppercase">Restaurents</h4>
            <h3 className={`text-secondary ${large?"large mb-2":"mb-3"}`}>Fringilla Ligula Pharetra Amet</h3>
